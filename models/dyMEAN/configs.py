...
# FoldX
FOLDX_BIN = os.path.join(PROJ_DIR, 'foldx5', 'foldx_20241231')
# DockQ 
# IMPORTANT: change it to your path to DockQ project)
DOCKQ_DIR = os.path.join(PROJ_DIR, 'DockQ')
# cache directory
...
# 4.2 docking
HDOCK_DIR = os.path.join(PROJ_DIR, 'HDOCKlite-v1.1')
# 4.3 CDR generation models
MEAN_DIR = os.path.join(PROJ_DIR, 'MEAN')
Rosetta_DIR = os.path.join(PROJ_DIR, 'rosetta', 'rosetta.binary.linux.release-362', 'main', 'source', 'bin')
DiffAb_DIR = './diffab'
